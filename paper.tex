...
\title{User Perceptions of Content Moderation Policies in Social Media Platforms}

\author{ Abril Rodriguez Almanzar, Fatima Madey }
...
\input{perception}
\input{effective}
\label{lastpage}\input{recommend}
